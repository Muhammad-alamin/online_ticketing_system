<head>
    ...
    <link rel="stylesheet" href="{{ asset('front/assets/css/bootstrap-slider.min.css') }}">
    <link rel="stylesheet" href="{{ asset('front/assets/css/jquery.scrolling-tabs.min.css') }}">
    <link rel="stylesheet" href="{{ asset('front/assets/css/bootstrap-checkbox.css') }}">
    <link rel="stylesheet" href="{{ asset('front/assets/css/flexslider.css') }}">
    <link rel="stylesheet" href="{{ asset('front/assets/css/featherlight.min.css') }}">
