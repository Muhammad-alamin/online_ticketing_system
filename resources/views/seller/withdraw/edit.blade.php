                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h4 class="nk-block-title page-title">Edit Withdrawl Request</h4>
                    ...
                    <div class="nk-block">
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-md-6 mb-4">
                                <div class="card">
                                    <div class="card-inner">
                                        <form action="{{route('vendor.withdrawl.update', encrypt($withdraw->id))}}" method="post" class="gy-3" enctype="multipart/form-data">
                                            @csrf
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="number" class="form-control" name="amount" id="amount" value="{{old('amount', isset($withdraw)?$withdraw->withdraw_amount:null)}}" placeholder="Amount you want to withdrawal">
                                                ...
                                                <div class="col-lg-10">
                                                    <div class="form-group">
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <textarea id="description" type="text" class="form-control" placeholder="Short Description" name="description" rows="4">{{old('vendor_message', isset($withdraw)?$withdraw->vendor_message:null)}}</textarea>
