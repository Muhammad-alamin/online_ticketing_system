                              ...
                              <tbody>
                                <tr>
                                  <td style="width:100%;text-align:left;height:33px">
                                    <a href="{{ route('Home') }}" title="Last Minute Football Ticket" rel="Last Minute Football Ticket">
                                        <img src="http://localhost/public/front/assets/images/last-minute-football-tickets-logo.png" alt="Last Minute Football Ticket" style="border:0" class="CToWUd" data-bit="iit">
                                    </a>
                                    </td>
                                </tr>
                              </tbody>
                                                  ...
                                                  <td>
                                                    <table border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse">
                                                      <tbody>
                                                        <tr>
                                                          <td>
                                                            <p style="margin:10px 0 10px 0;color:#565a5c;font-size:18px">Hi {{ $order_details->name }}!</p>
                                                            <p style="margin:10px 0 10px 0;color:#565a5c;font-size:18px">Thanks For Your Order.You Have Successfully Purchase {{ $order_details->ticket_quantity }} Tickets. Your Order ID: {{ $order_details->order_id }}. You Can Easily Manage Your Ticket by Dashboard.</p>
                                                          </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                          <td><a href="{{ route('seller.orders') }}" style="color:#1b74e4;text-decoration:none;display:block;width:370px" target="_blank" data-saferedirecturl="https://www.google.com/url?q=https://instagram.com/accounts/confirm_email/S5s9GbL6/cnVhc2luZ2hlMDFAZ21haWwuY29t/?app_redirect%3DFalse&amp;source=gmail&amp;ust=1658914278556000&amp;usg=AOvVaw1eF_-1j16FhP8HtQVHGD6s">
                                                                ...
                                                                <tbody>
                                                                  <tr>
                                                                    <td style="border-collapse:collapse;border-radius:3px;text-align:center;display:block;border:solid 1px #009fdf;padding:10px 16px 14px 16px;margin:0 2px 0 auto;min-width:80px;background-color:#47a2ea">
                                                                        <a href="{{ route('seller.orders') }}" style="color:#1b74e4;text-decoration:none;display:block" target="_blank" data-saferedirecturl="https://www.google.com/url?q=https://instagram.com/accounts/confirm_email/S5s9GbL6/cnVhc2luZ2hlMDFAZ21haWwuY29t/?app_redirect%3DFalse&amp;source=gmail&amp;ust=1658914278556000&amp;usg=AOvVaw1eF_-1j16FhP8HtQVHGD6s">
                                                                        <center>
                                                                          <font size="3"><span style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;white-space:nowrap;font-weight:bold;vertical-align:middle;color:#fdfdfd;font-size:16px;line-height:16px"><span class="il">See</span>&nbsp;Details</span></font>
                                                                        </center>
                                                                      </a>
                                                                    </td>
                                                                  </tr>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="text-align:center">
                            ...
                            <div style="color:#abadae;font-size:11px;margin:0 auto 5px auto">© Last Minute Football Ticket. Online Ticket Selling Platforms, Inc.<br></div>
                            {{-- <div style="color:#abadae;font-size:11px;margin:0 auto 5px auto">If you didn't change your Instagram <span class="il">email</span> address, <a href="" style="color:#abadae;text-decoration:underline" target="_blank" data-saferedirecturl="https://www.google.com/url?q=https://instagram.com/accounts/remove/revoke_wrong_email/?uidb36%3Dn752wk1%26token%3D5zw-22ded54809dcbad9c7a4d6282b8ed7fb%26nonce%3DBoDUVCNb%26encoded_email%3DcnVhc2luZ2hlMDFAZ21haWwuY29t&amp;source=gmail&amp;ust=1658914278556000&amp;usg=AOvVaw3Oe3Hp81PQfDyukdRF_9vN">revert this change</a>.<br></div> --}}
                          </td>
                          <td width="20" style="display:block;width:20px">&nbsp;&nbsp;&nbsp;</td>
                          <td width="15px" style="width:15px"></td>
                        </tr>
