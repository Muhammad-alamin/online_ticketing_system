                                                      ...
                                                      <tbody>
                                                        <tr>
                                                          <td>
                                                            ...
                                                            <p style="margin:10px 0 10px 0;color:#565a5c;font-size:18px">Congratulations! Your {{ $order_details->ticket_quantity }} Tickets Have been Already Sold. Your Ticket ID: {{ $order_details->order_ticket_id }}. You Can Easily See Details by Dashboard.</p>
                                                          </td>
                                                        </tr>
                                                        <tr>
