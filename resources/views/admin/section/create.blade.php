        ...
        <div class="container-fluid">
            <div class="nk-content-inner">
                <div class="nk-content-body">
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between g-3">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Section / <strong class="text-primary small">{{$event->match_name}}</strong></h3>
                            </div>
                            <div class="nk-block-head-content">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-inner">
                                                <form action="{{route('admin.add.section', $event->id)}}" method="post" class="gy-3" enctype="multipart/form-data">
                                                    @csrf
                                                        ...
                                                        <div class="col-lg-10">
                                                            <div class="form-group">
                                                                <div class="form-control-wrap">
                                                                    ...
                                                                    <input type="text" class="form-control" name="section_name" id="section_name" value="" placeholder="Enter section name">
                                                                    @error('section_name')<i class="text-danger">{{$message}}</i>@enderror
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row g-3 align-center">
                                                        <div class="col-lg-10">
                                                            <div class="form-group">
                                                                <label class="form-label" for="default-06">Section Image Upload</label>
                                                                <div class="form-control-wrap">
                                                                    <div class="custom-file">
                                                                        <input type="file" name="section_image" id="section_image" multiple class="custom-file-input" >
                                                                        <label class="custom-file-label" for="customFile">Choose file</label>
                                                                        @error('section_image')<i class="text-danger">{{$message}}</i>@enderror
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                            ...
                            <div class="col-sm-6 col-lg-6 col-xxl-3">
                                <div class="gallery card">
                                    <a class="gallery-image popup-image" href="./images/stock/a.jpg">
                                        <img class="w-100 rounded-top" src="{{asset($event->stadium_image)}}" alt="" style="height: 300px; width: 500px;">
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Section / <strong class="text-primary small">list</strong></h3>
                    </div>
                    <br>
                    <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                        <thead>
                        <tr class="nk-tb-item nk-tb-head">
                            <th class="nk-tb-col"><span class="sub-text">Section Name</span></th>
                            <th class="nk-tb-col tb-col-mb"><span class="sub-text">Section Image</span></th>
                        ...
                        @foreach($event['section'] as $key=>$section )
                            <tr class="nk-tb-item">
                                <td class="nk-tb-col">
                                    <div class="user-card">
                                        <div class="user-info">
                                            <span class="tb-lead">{{$section->section_name}}<span class="d-md-none ml-1"></span></span>
                                        </div>
                                    </div>
                                </td>
                                <td class="nk-tb-col tb-col-mb">
                                    <img src="{{asset($section->section_image)}}" class="img-fluid" alt="" style="height: 40px; width: 40px;">
                                </td>
                                            ...
                                            <div class="drodown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <ul class="link-list-opt no-bdr">
                                                        <li><a href="{{route('admin.edit.section',$section->id)}}"><em class="icon ni ni-edit"></em><span>Edit Section</span></a></li>
                                                        <li><a href="{{route('admin.delete.section', $section->id)}}" onclick="return confirm('Are You Confirm to Delete?')"><em class="icon ni ni-eye"></em><span>Delete Section</span></a></li>
