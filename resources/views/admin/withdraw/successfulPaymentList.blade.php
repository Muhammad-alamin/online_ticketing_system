                        ...
                        <div class="nk-block nk-block-lg">
                            <div class="nk-block-head">
                                <div class="nk-block-head-content">
                                    <h4 class="nk-block-title">Transection List</h4>
                                ...
                                <div class="card-inner">
                                    <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                        ...
                                        <tr class="nk-tb-item nk-tb-head">
                                            ...
                                            <th class="nk-tb-col tb-col-mb"><span class="sub-text">Pay Amount</span></th>
                                        ...
                                        @foreach($withdraws as $key=>$withdraw)
                                            <tr class="nk-tb-item">
                                                ...
                                                <td class="nk-tb-col tb-col-mb" data-order="35040.34">
                                                    <span>{{$withdraw->complete_date}}</span>
                                                </td>
                                                            ...
                                                            <div class="drodown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li><a href="{{route('admin.successfulPayment.details',encrypt($withdraw->id))}}"><em class="icon ni ni-eye"></em><span>Details</span></a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </li>
